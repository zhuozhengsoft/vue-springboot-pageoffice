...
public class WordResImageController {
    ...
    public String showWord(HttpServletRequest request) {
        ...
        data1.setValue("[image]/api/doc/WordResImage/1.jpg[/image]");
        DataRegion data2 = worddoc.openDataRegion("PO_p2");
        data2.setValue("[word]/api/doc/WordResImage/2.doc[/word]");
        DataRegion data3 = worddoc.openDataRegion("PO_p3");
        data3.setValue("[word]/api/doc/WordResImage/3.doc[/word]");
        ...
        //打开Word文档
        poCtrl.webOpen("/api/doc/WordResImage/test.doc", OpenModeType.docNormalEdit, "张三");
